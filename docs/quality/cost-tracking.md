...
```json
{"timestamp": "2026-04-29T15:31:22Z", "skill": "icon-creator", "model": "google/gemini-3.1-flash-image-preview", "n": 3, "cost_usd": 0.0432, "run_id": "..."}
{"timestamp": "2026-04-29T15:32:01Z", "skill": "icon-creator", "model": "google/gemini-3.1-flash-image-preview", "n": 1, "cost_usd": 0.0144, "run_id": "..."}
```
...
By model:
  google/gemini-3.1-flash-image-preview    $14.20  (612 calls)
...
Last 10 calls:
  2026-04-29 15:32  icon-creator       gemini-3.1-flash-image-preview    $0.014
  ...
```
