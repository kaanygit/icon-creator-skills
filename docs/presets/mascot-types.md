...
The canonical machine-readable source is `shared/presets/mascot_styles.yaml`. This document describes intent, fit, model choice, and rough vibe per preset. Current model IDs and retired fallbacks are tracked centrally in [model-matrix.md](model-matrix.md).
...
**Models**: `google/gemini-3.1-flash-image-preview` → `black-forest-labs/flux.2-pro`
...
**Models**: `black-forest-labs/flux.2-pro` → `google/gemini-3.1-flash-image-preview`
