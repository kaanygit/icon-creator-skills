...
**Models**: primary `google/gemini-3-pro-image-preview`, fallback `black-forest-labs/flux.2-pro`
...
**Models**: primary `black-forest-labs/flux.2-pro`, fallback `google/gemini-3-pro-image-preview`
