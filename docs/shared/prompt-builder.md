...
#   negative="...",
#   prompt_hash="abc123",
#   model_recommendation="sourceful/riverflow-v2-fast-preview",
...
icon-creator:
  flat:
    template: flat.j2
    primary_model: sourceful/riverflow-v2-fast-preview
  ...
  glass-morphism:
    ...
    fallback_models: [sourceful/riverflow-v2-fast-preview]
